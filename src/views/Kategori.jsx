...
export class Kategori extends Component {
  ...
  onDelete(kategori){
    ...
    fetch('http://localhost:5000/api/v1/kategori', {
        method: 'DELETE',
          ...
          <div className="card bg-default shadow">
            ...
            <div className="table-responsive">
              <table className="table align-items-center table-dark table-flush">
                ...
                <tbody>
                  {/* <!-- Kategori --> */}
                  {this.state.category.map(kategori =>
                  <tr key={kategori.id_kategori}>
                    <td>
                      <div className="media align-items-center">
                        <div className="media-body">
                          <span className="mb-0 text-sm">{kategori.id_kategori}</span>
                        </div>
                      </div>
                    </td>
                    <td>
                      <div className="media align-items-center">
                        <div className="media-body">
                          <span className="mb-0 text-sm">{kategori.nama_kategori}</span>
                        </div>
                      </div>
                    </td>
                    <td>
                    <button onClick={() => this.openModal(kategori)} data-toggle="modal"
                      data-target="#myModal" className="btn btn-sm btn-primary">Ubah</button>
                      <button onClick={() => this.onDelete(kategori)} className="btn btn-sm btn-primary">Hapus</button>
                    </td>
                  </tr>
                  )}
                    ...
                    <div className="modal-dialog" role="document">
                      <div className="modal-content">
                        <div className="modal-header">
                          <h5 className="modal-title">Tabel Kategori</h5>
